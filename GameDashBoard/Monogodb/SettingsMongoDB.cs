            ...
            PlayerCommon.Settings.AddFuncPathAction(typeof(WriteConcern),
                    ...
                    =>
                {
                    if (config.GetChildren().Any())
                    {
                        ...
                        var writeConcern = mgWriteConcern.CreateWriteConcern(PlayerCommon.Settings.GetPathSaveObj("GameSimulator:Mongodb:DriverSettings:WriteConcern") as WriteConcern
