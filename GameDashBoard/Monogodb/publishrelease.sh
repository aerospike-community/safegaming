...
dotnet publish GameDashBoardMG.csproj -a x64 -o ".\publish\Release\Aerospike" --self-contained true --configuration Release

echo "If successful, Published to './publish/Release/aerospike'"
echo "To run CD to './publish/Release/Aerospike' and execute './GameDashBoardMG -?'"
