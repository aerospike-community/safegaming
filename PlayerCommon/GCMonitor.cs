...
namespace PlayerCommon
{
    public sealed class GCMonitor
    {
        ...
        private readonly Thread gcMonitorThread;
        private readonly ThreadStart gcMonitorThreadStart;
        ...
        private GCMonitor()
        {
            ...
            this.consolerWriter.ReserveRwWriteConsoleSpace("GCMonitor", 2, -1, autoSizeConsoleWindow: true);
        ...
        private void DoGCMonitoring()
        {
            ...
            catch (Exception e)
            {
                ...
                this.consolerWriter.WriteLine($"GC Error! {e.Message}...");
            }
        }
    }
}
